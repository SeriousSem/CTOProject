...
public class EmployeeClientSqlDump {
    ...
    //private String DB_NAME = "DUMPDUMP100500";
    private String DB_NAME = "DUMPDUMP124";


    // Change path to the dump file
    private String PATH_TO_LOCAL_DUMP = "E:/dump.sql";
    ...
    public String login(String loginname, String psw) {
        ResultSet rs = dbc.executeQuery("SELECT * FROM employee WHERE (userLogin = '" + loginname + "' AND password = '" + psw + "');");
        try {
            if (rs.first()) {
