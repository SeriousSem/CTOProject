...
@Table(name = "customer")
@SessionScoped
// it means that this object will be accessible among users http sessions. If
// you
...
public class Customer extends UserAbstract implements Serializable {
	...
	// @OneToMany(targetEntity = Order.class, fetch = FetchType.LAZY, cascade =
	// CascadeType.ALL)
	...
	// if (address != null ? !address.equals(customer.address) :
	// customer.address != null) return false;
	// if (email != null ? !email.equals(customer.email) : customer.email !=
	// null) return false;
	// if (name != null ? !name.equals(customer.name) : customer.name != null)
	// return false;
	// if (orders != null ? !orders.equals(customer.orders) : customer.orders !=
	// null) return false;
	// if (surname != null ? !surname.equals(customer.surname) :
	// customer.surname != null) return false;
	//
	// return true;
	// }
	//
